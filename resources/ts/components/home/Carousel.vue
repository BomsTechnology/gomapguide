...
<template>
    ...
    >
        <div class="lg:flex items-center">
            <div class="lg:w-1/2 px-4 py-6">
                <p class="lg:text-justify text-center leading-8">
                    ...
                    Google My Business. Et  enfin permettre votre entreprise la
                    possibilité d’apparaître de manière optimale sur les moteurs
                    de recherche Google a tous moment
                </p>
            </div>
        ...
        <div
            class="border shadow-2xl w-96 hover:scale-105 transition-transform duration-100 mx-4"
        >
